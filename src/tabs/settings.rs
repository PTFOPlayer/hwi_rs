...
impl Tab for Settings {
    ...
    fn view(&self) -> iced::Element<'_, Self::Message> {
        ...
        let misc_column = column![graphs_switch, split_switch, url_input, graphs_size_input]
            .padding(20)
            .spacing(20);
...
impl Settings {
    pub fn new() -> Settings {
        Settings { url: "http://localhost:7172".to_string(), graphs_sizes: 50usize, graphs_switch: false }
    }
}